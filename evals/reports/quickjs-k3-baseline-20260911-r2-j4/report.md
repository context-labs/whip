# Whip evaluation: quickjs-k3-baseline-20260911-r2-j4
...
| --- | --- | --- | --- | --- | --- |
| candidate | 16/30 | 28 | 90.828266 | unknown | 314.68942693504505 |
...
- candidate: evidence 28/30; accounting 21/30; ungraded 2; termination causes {'none': 21, 'agent_error': 5, 'verifier_error': 2, 'benchmark_deadline': 2}.
...
| datacurve/expr-try-catch-errors | candidate | 1 | failed | agent_error | agent_error |
...
| datacurve/arktype-json-schema-refs-dependencies | candidate | 1 | passed | agent_error | agent_error |
...
| datacurve/scc-bounded-memory-spilling | candidate | 1 | failed | agent_error | agent_error |
| terminal-bench/dna-insert | candidate | 1 | error | runner_error | verifier_error |
| datacurve/katex-multicolumn-array-spans | candidate | 1 | failed | agent_error | agent_error |
