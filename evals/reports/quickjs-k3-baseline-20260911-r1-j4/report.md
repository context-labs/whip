# Whip evaluation: quickjs-k3-baseline-20260911-r1-j4
...
| --- | --- | --- | --- | --- | --- |
| candidate | 13/30 | 27 | 118.952884 | unknown | 398.22229854390025 |
...
- candidate: evidence 27/30; accounting 26/30; ungraded 3; termination causes {'none': 25, 'verifier_error': 3, 'benchmark_deadline': 2}.
- candidate / datacurve: 1/9 verified successes.
- candidate / terminal-bench: 12/21 verified successes.
...
| terminal-bench/constraints-scheduling | candidate | 1 | error | runner_error | verifier_error |
...
| terminal-bench/chess-best-move | candidate | 1 | error | runner_error | verifier_error |
...
| terminal-bench/merge-diff-arc-agi-task | candidate | 1 | error | runner_error | verifier_error |
...
| datacurve/fastapi-deprecation-response-headers | candidate | 1 | failed | completed | None |
