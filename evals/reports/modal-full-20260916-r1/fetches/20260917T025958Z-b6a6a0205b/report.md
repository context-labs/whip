# Whip evaluation: modal-full-20260916-r1

Status: **incomplete** (1 ungraded, 1 evidence-incomplete, 0 provider errors, 0 cancelled). Profile: **full**.
...
| --- | --- | --- | --- | --- | --- |
| candidate | 19/30 | 29 | 159.416540 | 5 | 86.985336262 |
...
- candidate: evidence 29/30; accounting 25/30; ungraded 1; provider errors 0; termination causes {'none': 27, 'agent_error': 1, 'benchmark_deadline': 2}.
- candidate / datacurve: 2/9 verified successes.
- candidate / terminal-bench: 17/21 verified successes.
...
| datacurve/expr-try-catch-errors | candidate | 1 | error | runner_error | agent_error |
...
| datacurve/katex-multicolumn-array-spans | candidate | 1 | passed | completed | None |
...
| terminal-bench/largest-eigenval | candidate | 1 | passed | timeout | benchmark_deadline |
...
| terminal-bench/extract-elf | candidate | 1 | passed | completed | None |
