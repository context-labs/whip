...
- [x] Build, verify, install and launch the signed preview on the owner's iPhone 16 Pro; see EVIDENCE.md.
- [ ] Complete the full interactive iOS workflow acceptance matrix.
