...
var rpcOperations = []Operation{
	...
	rpc[EnrollIdentityParams, IdentityResult]("identity.enroll", Ephemeral, "existing-human-enrollment", true),
	rpc[Empty, IdentityStatusResult]("identity.status", Query, "none", false),
	rpc[PermissionDecisionParams, PermissionDecisionResult]("permission.decide", Ephemeral, "signed-human-decision", true),
	rpc[PermissionModeParams, PermissionModeResult]("permission.mode", Ephemeral, "signed-human-mode", true),
