...
var rpcOperations = []Operation{
	...
	rpc[ProviderListParams, ProviderList]("provider.list", Query, "host-configuration", false),
	rpc[ProviderListParams, ProviderList]("provider.discover", Ephemeral, "host-configuration", false),
	rpc[ProviderNameParams, ProviderConfiguration]("provider.get", Query, "host-configuration", false),
	rpc[ProviderCreateParams, ProviderConfiguration]("provider.create", Ephemeral, "configuration-revision", true),
	rpc[ProviderUpdateParams, ProviderConfiguration]("provider.update", Ephemeral, "configuration-revision", true),
	rpc[ProviderRemoveParams, ProviderRemoveResult]("provider.remove", Ephemeral, "configuration-revision", false),
	rpc[ProviderDisconnectParams, ProviderStatus]("provider.disconnect", Ephemeral, "configuration-revision", false),
