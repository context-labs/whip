...
// unusableHome points WHIPCODE_HOME at a path under a regular file, so Dir()'s
...
// blockedPath makes name unwritable in WHIPCODE_HOME in the requested way, without
...
// TestNoConfigDirIsNotFatal: when the whipcode home can't be created, readers
