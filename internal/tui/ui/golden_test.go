	...
	for name, th := range themes {
		...
		t.Run(name, func(t *testing.T) {
			cases := map[string]string{
				...
				"statusbar":       StatusBar{Left: "~/src/whip · main · sonnet", Right: "ctrl+p commands", Width: 60}.Render(th),
				"statusbar-tight": StatusBar{Left: "a very long left side that will need truncating to fit", Right: "? help", Width: 40}.Render(th),
