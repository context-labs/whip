...
// stdlibModules are pure Starlark library modules. They make no host calls, so
// they bypass the keyword-only host-call convention and the request budget.
var stdlibModules = starlark.StringDict{
