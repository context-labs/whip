...
- json.encode(value), json.decode(text): local JSON helpers, not host calls; decode complete JSON, not incomplete handle-read chunks
...
Rules:
- Host module operations accept keyword arguments only; local json helpers accept positional arguments.
