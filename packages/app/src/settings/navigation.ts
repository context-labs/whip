...
export const settingEntries: readonly SettingEntry[] = [
  ...
  { id: 'default_model', section: 'providers', label: 'Default model', keywords: 'model route' },
  { id: 'default_provider', section: 'providers', label: 'Default provider', keywords: 'model route' },
