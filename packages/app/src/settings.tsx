  ...
  return (
    <div {...stylex.props(layout.column)}>
      ...
      {runtime.platform.notify && <Switch label="Desktop notifications"
        description="Notify me about new permission requests and questions while Whip is open, including when its window is hidden. Checks up to 256 active sessions on the connected host. Notifications stop when Whip quits."
