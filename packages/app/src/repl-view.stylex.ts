...
export const styles = stylex.create({
  ...
  toolbar: { display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 8, padding: 12, borderBottomWidth: 1, borderBottomStyle: 'solid', borderBottomColor: surface.quietBorder, fontSize: 13 },
  title: { display: 'flex', alignItems: 'center', gap: 6, fontWeight: 550, marginRight: 4 },
  agent: { minWidth: 0, maxWidth: '100%', backgroundColor: 'transparent' },
  count: { fontSize: 12, color: surface.secondaryText, marginLeft: 'auto', whiteSpace: 'nowrap' },
  notice: { fontSize: 12, lineHeight: 1.5, color: surface.secondaryText, padding: '8px 16px', margin: 0 },
  ...
  header: { display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 8, minHeight: { default: 28, [scale.touch]: 44 }, marginBottom: 8, fontSize: 12 },
  ordinal: { fontFamily: typography.mono, fontSize: 12, fontWeight: 500 },
  meta: { color: surface.secondaryText, fontSize: 12 },
  grow: { flex: 1 },
  code: { borderWidth: 0, borderStyle: 'none', borderRadius: 6 },
  hosts: { display: 'flex', flexDirection: 'column', gap: 5, paddingBlock: 10, fontFamily: typography.mono, fontSize: 12, lineHeight: 1.6 },
