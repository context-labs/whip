...
JSON payloads remain JSON. Preserve exact bytes when signing human approval
payloads. Never persist provider credentials or terminal input in a client
