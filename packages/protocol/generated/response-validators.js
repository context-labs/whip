...
const schema11 = {"type":"object","properties":{"accepted":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/Accepted","$schema":"http://json-schema.org/draft-07/schema#","title":"Accepted","required":["accepted"],"additionalProperties":true};
...
const schema12 = {"type":"object","properties":{"id":{"type":"string"},"turn_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/AgentCancelParams","$schema":"http://json-schema.org/draft-07/schema#","title":"AgentCancelParams","required":["id","turn_id"],"additionalProperties":true};
...
const schema13 = {"type":"object","properties":{"id":{"type":"string"},"text":{"type":"string"},"delivery":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/AgentInputParams","$schema":"http://json-schema.org/draft-07/schema#","title":"AgentInputParams","required":["id","text"],"additionalProperties":true};
...
const schema15 = {"type":"object","properties":{"agent_id":{"type":"string"},"inbox_seq":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"kind":{"type":"string"},"status":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/AgentSubmitResult","$schema":"http://json-schema.org/draft-07/schema#","title":"AgentSubmitResult","required":["agent_id","inbox_seq","status"],"additionalProperties":true};
...
const schema18 = {"type":"object","properties":{"driver":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/BrowserDriverParams","$schema":"http://json-schema.org/draft-07/schema#","title":"BrowserDriverParams","required":["driver"],"additionalProperties":true};
...
const schema19 = {"type":"object","properties":{"enabled":{"type":"boolean"},"driver":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/BrowserStatusResult","$schema":"http://json-schema.org/draft-07/schema#","title":"BrowserStatusResult","required":["enabled"],"additionalProperties":true};
...
const schema20 = {"type":"object","properties":{"id":{"type":"string"},"kind":{"type":"string"},"limit":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"}},"$id":"https://whip.dev/protocol/v3/BudgetCapParams","$schema":"http://json-schema.org/draft-07/schema#","title":"BudgetCapParams","required":["id","kind","limit"],"additionalProperties":true};
...
const schema22 = {"type":"object","properties":{"turn_id":{"type":"string"},"target_command_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/CancelParams","$schema":"http://json-schema.org/draft-07/schema#","title":"CancelParams","additionalProperties":true};
...
const schema23 = {"type":"object","properties":{"id":{"type":"string"},"root_id":{"type":"string"},"agent_id":{"type":"string"},"issuer_agent_id":{"type":"string"},"operations":{"type":["null","array"],"items":{"type":"string"}},"scopes":{"type":["null","array"],"items":{"type":"string"}},"mcp":{"type":["null","array"],"items":{"type":"object","properties":{"server":{"type":"string"},"tool":{"type":"string"},"definition":{"type":"string"}},"required":["server","tool","definition"],"additionalProperties":true}},"mcp_all":{"type":"boolean"},"generation":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"status":{"type":"string"},"expires_at":{"type":"string"},"created_at":{"type":"string"},"updated_at":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/CapabilityRecord","$schema":"http://json-schema.org/draft-07/schema#","title":"CapabilityRecord","required":["id","root_id","agent_id","issuer_agent_id","operations","scopes","mcp","mcp_all","generation","status","expires_at","created_at","updated_at"],"additionalProperties":true};
...
const schema24 = {"type":"object","properties":{"revision":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"}},"$id":"https://whip.dev/protocol/v3/CatalogRevision","$schema":"http://json-schema.org/draft-07/schema#","title":"CatalogRevision","required":["revision"],"additionalProperties":true};
...
const schema25 = {"type":"object","properties":{"reason":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/CheckpointParams","$schema":"http://json-schema.org/draft-07/schema#","title":"CheckpointParams","additionalProperties":true};
...
const schema27 = {"type":"object","properties":{"content":{"type":["null","object"],"properties":{"reference_id":{"type":"string"},"digest":{"type":"string"},"size":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"media_type":{"type":"string"},"source":{"type":"string"}},"required":["reference_id","digest","size"],"additionalProperties":true},"operation":{"type":"string"},"result":true,"failure":{"type":["null","object"],"properties":{"data":{"type":["null","object"],"properties":{"kind":{"type":"string"}},"required":["kind"],"additionalProperties":true},"code":{"type":"integer"},"message":{"type":"string"}},"required":["code","message"],"additionalProperties":true},"command_id":{"type":"string"},"ingress_seq":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"status":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/CommandResult","$schema":"http://json-schema.org/draft-07/schema#","title":"CommandResult","required":["operation","command_id","ingress_seq","status"],"additionalProperties":true};
...
const schema28 = {"type":"object","properties":{"command_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/CommandStatusParams","$schema":"http://json-schema.org/draft-07/schema#","title":"CommandStatusParams","required":["command_id"],"additionalProperties":true};
...
const schema29 = {"type":["null","array"],"items":{"type":"object","properties":{"seq":{"type":"integer"},"cutoff":{"type":"integer"},"summary":{"type":"string"}},"required":["seq","cutoff","summary"],"additionalProperties":true},"$id":"https://whip.dev/protocol/v3/CompactionListResult","$schema":"http://json-schema.org/draft-07/schema#","title":"CompactionListResult"};
...
const schema30 = {"type":"object","properties":{"model":{"type":"string"},"provider":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/CompactionParams","$schema":"http://json-schema.org/draft-07/schema#","title":"CompactionParams","additionalProperties":true};
...
const schema32 = {"type":"object","properties":{"undone":{"type":"boolean"},"sequence":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/CompactionRetryResult","$schema":"http://json-schema.org/draft-07/schema#","title":"CompactionRetryResult","required":["undone"],"additionalProperties":true};
...
const schema33 = {"type":"object","properties":{"model":{"type":"string"},"provider":{"type":"string"},"builtin_default":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/CompactionSettingsResult","$schema":"http://json-schema.org/draft-07/schema#","title":"CompactionSettingsResult","required":["builtin_default"],"additionalProperties":true};
...
const schema35 = {"type":"object","properties":{"warnings":{"type":["null","array"],"items":{"type":"string"}},"candidates":{"type":["null","array"],"items":{"type":"object","properties":{"text":{"type":"string"},"description":{"type":"string"}},"required":["text","description"],"additionalProperties":true}},"truncated":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/CompletionResult","$schema":"http://json-schema.org/draft-07/schema#","title":"CompletionResult","required":["candidates","truncated"],"additionalProperties":true};
...
const schema36 = {"type":"object","properties":{"app":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ComputerAppParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ComputerAppParams","required":["app"],"additionalProperties":true};
...
const schema40 = {"type":"object","properties":{"reference_id":{"type":"string"},"digest":{"type":"string"},"size":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"media_type":{"type":"string"},"source":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ContentHandle","$schema":"http://json-schema.org/draft-07/schema#","title":"ContentHandle","required":["reference_id","digest","size"],"additionalProperties":true};
...
const schema44 = {"type":"object","properties":{"kind":{"type":"string"},"cwd":{"type":"string"},"model":{"type":"string"},"provider":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/CreateSessionParams","$schema":"http://json-schema.org/draft-07/schema#","title":"CreateSessionParams","required":["kind","cwd","model","provider"],"additionalProperties":true};
...
const schema45 = {"type":"object","properties":{"effort":{"type":"string"},"persist_default":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/EffortParams","$schema":"http://json-schema.org/draft-07/schema#","title":"EffortParams","required":["effort","persist_default"],"additionalProperties":true};
...
const schema46 = {"type":"object","properties":{"effort":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/EffortResult","$schema":"http://json-schema.org/draft-07/schema#","title":"EffortResult","required":["effort"],"additionalProperties":true};
...
const schema47 = {"type":"object","$id":"https://whip.dev/protocol/v3/Empty","$schema":"http://json-schema.org/draft-07/schema#","title":"Empty","additionalProperties":true};
...
const schema48 = {"type":"object","$id":"https://whip.dev/protocol/v3/EmptyParams","$schema":"http://json-schema.org/draft-07/schema#","title":"EmptyParams","additionalProperties":true};
...
const schema50 = {"type":"object","properties":{"expected_revision":{"type":["string","null"],"pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"title":{"type":"string"},"cut":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/ForkParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ForkParams","required":["expected_revision"],"additionalProperties":true};
...
if((typeof data0 !== "string") && (data0 !== null)){
const err1 = {instancePath:instancePath+"/expected_revision",schemaPath:"#/properties/expected_revision/type",keyword:"type",params:{type: schema50.properties.expected_revision.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err1];
}
else {
...
const schema51 = {"type":"object","properties":{"window":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/GoalContextParams","$schema":"http://json-schema.org/draft-07/schema#","title":"GoalContextParams","additionalProperties":true};
...
const schema52 = {"type":"object","properties":{"goal":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/GoalResult","$schema":"http://json-schema.org/draft-07/schema#","title":"GoalResult","required":["goal"],"additionalProperties":true};
...
const err10 = {instancePath:instancePath+"/revision",schemaPath:"#/properties/revision/type",keyword:"type",params:{type: schema53.properties.revision.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err10];
}
else {
...
const schema54 = {"type":"object","properties":{"id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/IDParams","$schema":"http://json-schema.org/draft-07/schema#","title":"IDParams","required":["id"],"additionalProperties":true};
...
if((data4 !== null) && (!(Array.isArray(data4)))){
const err8 = {instancePath:instancePath+"/capabilities",schemaPath:"#/properties/capabilities/type",keyword:"type",params:{type: schema55.properties.capabilities.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
if((data0 !== null) && (!(Array.isArray(data0)))){
const err12 = {instancePath:instancePath+"/operations",schemaPath:"#/properties/operations/type",keyword:"type",params:{type: schema56.properties.operations.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err12];
}
else {
...
if(data1 && typeof data1 == "object" && !Array.isArray(data1)){
if(data1.name === undefined){
const err13 = {instancePath:instancePath+"/operations/" + i0,schemaPath:"#/properties/operations/items/required",keyword:"required",params:{missingProperty: "name"},message:"must have required property '"+"name"+"'"};
if(vErrors === null){
vErrors = [err13];
}
else {
...
const err14 = {instancePath:instancePath+"/operations/" + i0,schemaPath:"#/properties/operations/items/required",keyword:"required",params:{missingProperty: "surface"},message:"must have required property '"+"surface"+"'"};
if(vErrors === null){
vErrors = [err14];
}
else {
...
const err15 = {instancePath:instancePath+"/operations/" + i0,schemaPath:"#/properties/operations/items/required",keyword:"required",params:{missingProperty: "execution"},message:"must have required property '"+"execution"+"'"};
if(vErrors === null){
vErrors = [err15];
}
else {
...
const err16 = {instancePath:instancePath+"/operations/" + i0,schemaPath:"#/properties/operations/items/required",keyword:"required",params:{missingProperty: "permission"},message:"must have required property '"+"permission"+"'"};
if(vErrors === null){
vErrors = [err16];
}
else {
...
if(data1.name !== undefined){
if(typeof data1.name !== "string"){
const err17 = {instancePath:instancePath+"/operations/" + i0+"/name",schemaPath:"#/properties/operations/items/properties/name/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err17];
}
else {
...
const err18 = {instancePath:instancePath+"/operations/" + i0+"/surface",schemaPath:"#/properties/operations/items/properties/surface/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err18];
}
else {
...
const err19 = {instancePath:instancePath+"/operations/" + i0+"/execution",schemaPath:"#/properties/operations/items/properties/execution/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err19];
}
else {
...
const err20 = {instancePath:instancePath+"/operations/" + i0+"/permission",schemaPath:"#/properties/operations/items/properties/permission/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err20];
}
else {
...
const err21 = {instancePath:instancePath+"/operations/" + i0+"/sensitive",schemaPath:"#/properties/operations/items/properties/sensitive/type",keyword:"type",params:{type: "boolean"},message:"must be boolean"};
if(vErrors === null){
vErrors = [err21];
}
else {
...
const err22 = {instancePath:instancePath+"/operations/" + i0,schemaPath:"#/properties/operations/items/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err22];
}
else {
...
const err23 = {instancePath:instancePath+"/limits",schemaPath:"#/properties/limits/required",keyword:"required",params:{missingProperty: "frame_bytes"},message:"must have required property '"+"frame_bytes"+"'"};
if(vErrors === null){
vErrors = [err23];
}
else {
...
const err24 = {instancePath:instancePath+"/limits",schemaPath:"#/properties/limits/required",keyword:"required",params:{missingProperty: "connections"},message:"must have required property '"+"connections"+"'"};
if(vErrors === null){
vErrors = [err24];
}
else {
...
const err25 = {instancePath:instancePath+"/limits",schemaPath:"#/properties/limits/required",keyword:"required",params:{missingProperty: "in_flight_requests"},message:"must have required property '"+"in_flight_requests"+"'"};
if(vErrors === null){
vErrors = [err25];
}
else {
...
const err26 = {instancePath:instancePath+"/limits",schemaPath:"#/properties/limits/required",keyword:"required",params:{missingProperty: "outbound_messages"},message:"must have required property '"+"outbound_messages"+"'"};
if(vErrors === null){
vErrors = [err26];
}
else {
...
const err27 = {instancePath:instancePath+"/limits",schemaPath:"#/properties/limits/required",keyword:"required",params:{missingProperty: "outbound_bytes"},message:"must have required property '"+"outbound_bytes"+"'"};
if(vErrors === null){
vErrors = [err27];
}
else {
...
const err28 = {instancePath:instancePath+"/limits",schemaPath:"#/properties/limits/required",keyword:"required",params:{missingProperty: "root_subscriptions"},message:"must have required property '"+"root_subscriptions"+"'"};
if(vErrors === null){
vErrors = [err28];
}
else {
...
const err29 = {instancePath:instancePath+"/limits",schemaPath:"#/properties/limits/required",keyword:"required",params:{missingProperty: "content_chunk_bytes"},message:"must have required property '"+"content_chunk_bytes"+"'"};
if(vErrors === null){
vErrors = [err29];
}
else {
...
const err30 = {instancePath:instancePath+"/limits",schemaPath:"#/properties/limits/required",keyword:"required",params:{missingProperty: "upload_bytes"},message:"must have required property '"+"upload_bytes"+"'"};
if(vErrors === null){
vErrors = [err30];
}
else {
...
const err31 = {instancePath:instancePath+"/limits/frame_bytes",schemaPath:"#/properties/limits/properties/frame_bytes/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err31];
}
else {
...
if(!((typeof data9 == "number") && (!(data9 % 1) && !isNaN(data9)))){
const err32 = {instancePath:instancePath+"/limits/connections",schemaPath:"#/properties/limits/properties/connections/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err32];
}
else {
...
if(!((typeof data10 == "number") && (!(data10 % 1) && !isNaN(data10)))){
const err33 = {instancePath:instancePath+"/limits/in_flight_requests",schemaPath:"#/properties/limits/properties/in_flight_requests/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err33];
}
else {
...
if(!((typeof data11 == "number") && (!(data11 % 1) && !isNaN(data11)))){
const err34 = {instancePath:instancePath+"/limits/outbound_messages",schemaPath:"#/properties/limits/properties/outbound_messages/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err34];
}
else {
...
const err35 = {instancePath:instancePath+"/limits/outbound_bytes",schemaPath:"#/properties/limits/properties/outbound_bytes/pattern",keyword:"pattern",params:{pattern: "^-?(0|[1-9][0-9]*)$"},message:"must match pattern \""+"^-?(0|[1-9][0-9]*)$"+"\""};
if(vErrors === null){
vErrors = [err35];
}
else {
...
const err36 = {instancePath:instancePath+"/limits/outbound_bytes",schemaPath:"#/properties/limits/properties/outbound_bytes/format",keyword:"format",params:{format: "int64"},message:"must match format \""+"int64"+"\""};
if(vErrors === null){
vErrors = [err36];
}
else {
...
const err37 = {instancePath:instancePath+"/limits/outbound_bytes",schemaPath:"#/properties/limits/properties/outbound_bytes/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err37];
}
else {
...
const err38 = {instancePath:instancePath+"/limits/root_subscriptions",schemaPath:"#/properties/limits/properties/root_subscriptions/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err38];
}
else {
...
const err39 = {instancePath:instancePath+"/limits/content_chunk_bytes",schemaPath:"#/properties/limits/properties/content_chunk_bytes/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err39];
}
else {
...
const err40 = {instancePath:instancePath+"/limits/upload_bytes",schemaPath:"#/properties/limits/properties/upload_bytes/pattern",keyword:"pattern",params:{pattern: "^-?(0|[1-9][0-9]*)$"},message:"must match pattern \""+"^-?(0|[1-9][0-9]*)$"+"\""};
if(vErrors === null){
vErrors = [err40];
}
else {
...
const err41 = {instancePath:instancePath+"/limits/upload_bytes",schemaPath:"#/properties/limits/properties/upload_bytes/format",keyword:"format",params:{format: "int64"},message:"must match format \""+"int64"+"\""};
if(vErrors === null){
vErrors = [err41];
}
else {
...
const err42 = {instancePath:instancePath+"/limits/upload_bytes",schemaPath:"#/properties/limits/properties/upload_bytes/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err42];
}
else {
...
const err43 = {instancePath:instancePath+"/limits",schemaPath:"#/properties/limits/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err43];
}
else {
...
if((data16 !== null) && (!(Array.isArray(data16)))){
const err44 = {instancePath:instancePath+"/negotiated_capabilities",schemaPath:"#/properties/negotiated_capabilities/type",keyword:"type",params:{type: schema56.properties.negotiated_capabilities.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err44];
}
else {
...
const err45 = {instancePath:instancePath+"/negotiated_capabilities/" + i1,schemaPath:"#/properties/negotiated_capabilities/items/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err45];
}
else {
...
const err46 = {instancePath:instancePath+"/protocol_minor",schemaPath:"#/properties/protocol_minor/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err46];
}
else {
...
const err47 = {instancePath:instancePath+"/runtime_id",schemaPath:"#/properties/runtime_id/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err47];
}
else {
...
const err48 = {instancePath:instancePath+"/connection_id",schemaPath:"#/properties/connection_id/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err48];
}
else {
...
const err49 = {instancePath:instancePath+"/host_platform",schemaPath:"#/properties/host_platform/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err49];
}
else {
...
const err50 = {instancePath:instancePath+"/host_architecture",schemaPath:"#/properties/host_architecture/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err50];
}
else {
...
const err51 = {instancePath:instancePath+"/network_endpoint",schemaPath:"#/properties/network_endpoint/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err51];
}
else {
...
const err52 = {instancePath:instancePath+"/protocol_major",schemaPath:"#/properties/protocol_major/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err52];
}
else {
...
if(data.build_id !== undefined){
if(typeof data.build_id !== "string"){
const err53 = {instancePath:instancePath+"/build_id",schemaPath:"#/properties/build_id/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err53];
}
else {
...
const err54 = {instancePath:instancePath+"/generation",schemaPath:"#/properties/generation/pattern",keyword:"pattern",params:{pattern: "^-?(0|[1-9][0-9]*)$"},message:"must match pattern \""+"^-?(0|[1-9][0-9]*)$"+"\""};
if(vErrors === null){
vErrors = [err54];
}
else {
...
const err55 = {instancePath:instancePath+"/generation",schemaPath:"#/properties/generation/format",keyword:"format",params:{format: "int64"},message:"must match format \""+"int64"+"\""};
if(vErrors === null){
vErrors = [err55];
}
else {
...
const err56 = {instancePath:instancePath+"/generation",schemaPath:"#/properties/generation/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err56];
}
else {
...
let data27 = data.pid;
if(!((typeof data27 == "number") && (!(data27 % 1) && !isNaN(data27)))){
const err57 = {instancePath:instancePath+"/pid",schemaPath:"#/properties/pid/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err57];
}
else {
...
const err58 = {instancePath:instancePath+"/started_at",schemaPath:"#/properties/started_at/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err58];
}
else {
...
const err59 = {instancePath:instancePath+"/capabilities",schemaPath:"#/properties/capabilities/type",keyword:"type",params:{type: schema56.properties.capabilities.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err59];
}
else {
...
const err60 = {instancePath:instancePath+"/capabilities/" + i2,schemaPath:"#/properties/capabilities/items/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err60];
}
else {
...
const schema57 = {"type":["null","array"],"items":{"type":"object","properties":{"name":{"type":"string"},"root":{"type":"string"},"state":{"type":"string"},"error":{"type":"string"}},"required":["name","state"],"additionalProperties":true},"$id":"https://whip.dev/protocol/v3/LSPListResult","$schema":"http://json-schema.org/draft-07/schema#","title":"LSPListResult"};
...
const err32 = {instancePath:instancePath+"/restored",schemaPath:"#/properties/restored/type",keyword:"type",params:{type: schema58.properties.restored.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err32];
}
else {
...
const err34 = {instancePath:instancePath+"/not_restored",schemaPath:"#/properties/not_restored/type",keyword:"type",params:{type: schema58.properties.not_restored.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err34];
}
else {
...
const err67 = {instancePath:instancePath+"/options",schemaPath:"#/properties/options/type",keyword:"type",params:{type: schema58.properties.options.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err67];
}
else {
...
const err73 = {instancePath:instancePath+"/answer",schemaPath:"#/properties/answer/type",keyword:"type",params:{type: schema58.properties.answer.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err73];
}
else {
...
const schema59 = {"type":"object","properties":{"limit":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/ListParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ListParams","additionalProperties":true};
...
if((data2 !== null) && (!(Array.isArray(data2)))){
const err1 = {instancePath:instancePath+"/servers/" + key0.replace(/~/g, "~0").replace(/\//g, "~1")+"/command",schemaPath:"#/properties/servers/additionalProperties/properties/command/type",keyword:"type",params:{type: schema60.properties.servers.additionalProperties.properties.command.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err1];
}
else {
...
const err9 = {instancePath:instancePath+"/servers/" + key0.replace(/~/g, "~0").replace(/\//g, "~1")+"/enabled",schemaPath:"#/properties/servers/additionalProperties/properties/enabled/type",keyword:"type",params:{type: schema60.properties.servers.additionalProperties.properties.enabled.type},message:"must be null,boolean"};
if(vErrors === null){
vErrors = [err9];
}
else {
...
const schema61 = {"type":"object","properties":{"source":{"type":"string"},"enabled":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/MCPImportParams","$schema":"http://json-schema.org/draft-07/schema#","title":"MCPImportParams","required":["source","enabled"],"additionalProperties":true};
...
const schema62 = {"type":"object","properties":{"claude":{"type":"boolean"},"codex":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/MCPImportStatusResult","$schema":"http://json-schema.org/draft-07/schema#","title":"MCPImportStatusResult","required":["claude","codex"],"additionalProperties":true};
...
const schema63 = {"type":["null","array"],"items":{"type":"object","properties":{"name":{"type":"string"},"status":{"type":"string"},"note":{"type":"string"},"error":{"type":"string"},"tools":{"type":"integer"},"source":{"type":"string"}},"required":["name","status"],"additionalProperties":true},"$id":"https://whip.dev/protocol/v3/MCPListResult","$schema":"http://json-schema.org/draft-07/schema#","title":"MCPListResult"};
...
const schema64 = {"type":"object","properties":{"name":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/MCPServerParams","$schema":"http://json-schema.org/draft-07/schema#","title":"MCPServerParams","required":["name"],"additionalProperties":true};
...
const schema65 = {"type":"object","properties":{"model":{"type":"string"},"provider":{"type":"string"},"persist_default":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/ModelParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ModelParams","required":["model","persist_default"],"additionalProperties":true};
...
const schema66 = {"type":"object","properties":{"reload_pending":{"type":"boolean"},"model":{"type":"string"},"provider":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ModelResult","$schema":"http://json-schema.org/draft-07/schema#","title":"ModelResult","required":["model","provider"],"additionalProperties":true};
...
const schema67 = {"type":"object","properties":{"path":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/PathParams","$schema":"http://json-schema.org/draft-07/schema#","title":"PathParams","required":["path"],"additionalProperties":true};
...
const schema68 = {"type":"object","properties":{"path":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/PathResult","$schema":"http://json-schema.org/draft-07/schema#","title":"PathResult","required":["path"],"additionalProperties":true};
...
const schema69 = {"type":"object","properties":{"external_permissions":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/PermissionConfigureParams","$schema":"http://json-schema.org/draft-07/schema#","title":"PermissionConfigureParams","required":["external_permissions"],"additionalProperties":true};
...
const err1 = {instancePath:instancePath+"/decision",schemaPath:"#/properties/decision/required",keyword:"required",params:{missingProperty: "command_id"},message:"must have required property '"+"command_id"+"'"};
if(vErrors === null){
vErrors = [err1];
}
else {
...
if(data0.root_id === undefined){
const err2 = {instancePath:instancePath+"/decision",schemaPath:"#/properties/decision/required",keyword:"required",params:{missingProperty: "root_id"},message:"must have required property '"+"root_id"+"'"};
if(vErrors === null){
vErrors = [err2];
}
else {
...
const err3 = {instancePath:instancePath+"/decision",schemaPath:"#/properties/decision/required",keyword:"required",params:{missingProperty: "permission_id"},message:"must have required property '"+"permission_id"+"'"};
if(vErrors === null){
vErrors = [err3];
}
else {
...
const err4 = {instancePath:instancePath+"/decision",schemaPath:"#/properties/decision/required",keyword:"required",params:{missingProperty: "allow"},message:"must have required property '"+"allow"+"'"};
if(vErrors === null){
vErrors = [err4];
}
else {
...
const err5 = {instancePath:instancePath+"/decision/command_id",schemaPath:"#/properties/decision/properties/command_id/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err5];
}
else {
...
if(data0.root_id !== undefined){
if(typeof data0.root_id !== "string"){
const err6 = {instancePath:instancePath+"/decision/root_id",schemaPath:"#/properties/decision/properties/root_id/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err6];
}
else {
...
const err7 = {instancePath:instancePath+"/decision/permission_id",schemaPath:"#/properties/decision/properties/permission_id/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err7];
}
else {
...
const err8 = {instancePath:instancePath+"/decision/allow",schemaPath:"#/properties/decision/properties/allow/type",keyword:"type",params:{type: "boolean"},message:"must be boolean"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
const err9 = {instancePath:instancePath+"/decision/reason",schemaPath:"#/properties/decision/properties/reason/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err9];
}
else {
...
const err10 = {instancePath:instancePath+"/decision/remember",schemaPath:"#/properties/decision/properties/remember/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err10];
}
else {
...
const err11 = {instancePath:instancePath+"/decision",schemaPath:"#/properties/decision/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err11];
}
else {
...
const schema72 = {"type":"object","properties":{"operation_id":{"type":"string"},"lease_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/PermissionDecisionResult","$schema":"http://json-schema.org/draft-07/schema#","title":"PermissionDecisionResult","required":["operation_id","lease_id"],"additionalProperties":true};
...
if(data.operation_id !== undefined){
if(typeof data.operation_id !== "string"){
const err2 = {instancePath:instancePath+"/operation_id",schemaPath:"#/properties/operation_id/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err2];
}
else {
...
const err3 = {instancePath:instancePath+"/lease_id",schemaPath:"#/properties/lease_id/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err3];
}
else {
...
if((data0 !== null) && (!(Array.isArray(data0)))){
const err2 = {instancePath:instancePath+"/rules",schemaPath:"#/properties/rules/type",keyword:"type",params:{type: schema73.properties.rules.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err2];
}
else {
...
if((data8 !== null) && (!(Array.isArray(data8)))){
const err16 = {instancePath:instancePath+"/global",schemaPath:"#/properties/global/type",keyword:"type",params:{type: schema73.properties.global.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err16];
}
else {
...
const schema74 = {"type":"object","properties":{"generation":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"build_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/PingResult","$schema":"http://json-schema.org/draft-07/schema#","title":"PingResult","required":["generation","build_id"],"additionalProperties":true};
...
if((data4 !== null) && (!(Array.isArray(data4)))){
const err6 = {instancePath:instancePath+"/models/" + key0.replace(/~/g, "~0").replace(/\//g, "~1")+"/providers",schemaPath:"#/properties/models/additionalProperties/properties/providers/type",keyword:"type",params:{type: schema75.properties.models.additionalProperties.properties.providers.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err6];
}
else {
...
if((data15 !== null) && (!(Array.isArray(data15)))){
const err21 = {instancePath:instancePath+"/catalogs/" + key2.replace(/~/g, "~0").replace(/\//g, "~1")+"/models",schemaPath:"#/properties/catalogs/additionalProperties/properties/models/type",keyword:"type",params:{type: schema75.properties.catalogs.additionalProperties.properties.models.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err21];
}
else {
...
const schema76 = {"type":"object","properties":{"revision":{"type":"string"},"provider":{"type":"string"},"key":{"type":"string"},"environment":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/ProviderKeySetup","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderKeySetup","required":["revision","provider","environment"],"additionalProperties":true};
...
const schema77 = {"type":"object","properties":{"flow_id":{"type":"string"},"name":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ProviderLoginCreateParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderLoginCreateParams","required":["flow_id","name"],"additionalProperties":true};
...
const schema78 = {"type":"object","properties":{"flows":{"type":["null","array"],"items":{"type":"object","properties":{"flow_id":{"type":"string"},"state":{"type":"string"},"verification_url":{"type":"string"},"user_code":{"type":"string"},"email":{"type":"string"},"teams":{"type":["null","array"],"items":{"type":"object","properties":{"id":{"type":"string"},"name":{"type":"string"}},"required":["id","name"],"additionalProperties":true}},"projects":{"type":["null","array"],"items":{"type":"object","properties":{"id":{"type":"string"},"name":{"type":"string"}},"required":["id","name"],"additionalProperties":true}},"team_id":{"type":"string"},"project_id":{"type":"string"},"expires_at":{"type":"string"},"error":{"type":"string"}},"required":["flow_id","state","teams","projects","expires_at"],"additionalProperties":true}}},"$id":"https://whip.dev/protocol/v3/ProviderLoginList","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderLoginList","required":["flows"],"additionalProperties":true};
...
if((data0 !== null) && (!(Array.isArray(data0)))){
const err1 = {instancePath:instancePath+"/flows",schemaPath:"#/properties/flows/type",keyword:"type",params:{type: schema78.properties.flows.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err1];
}
else {
...
const err12 = {instancePath:instancePath+"/flows/" + i0+"/teams",schemaPath:"#/properties/flows/items/properties/teams/type",keyword:"type",params:{type: schema78.properties.flows.items.properties.teams.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err12];
}
else {
...
const err18 = {instancePath:instancePath+"/flows/" + i0+"/projects",schemaPath:"#/properties/flows/items/properties/projects/type",keyword:"type",params:{type: schema78.properties.flows.items.properties.projects.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err18];
}
else {
...
const schema79 = {"type":"object","properties":{"flow_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ProviderLoginParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderLoginParams","required":["flow_id"],"additionalProperties":true};
...
const schema80 = {"type":"object","properties":{"flow_id":{"type":"string"},"project_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ProviderLoginProjectParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderLoginProjectParams","required":["flow_id","project_id"],"additionalProperties":true};
...
const schema81 = {"type":"object","properties":{"flow_id":{"type":"string"},"state":{"type":"string"},"verification_url":{"type":"string"},"user_code":{"type":"string"},"email":{"type":"string"},"teams":{"type":["null","array"],"items":{"type":"object","properties":{"id":{"type":"string"},"name":{"type":"string"}},"required":["id","name"],"additionalProperties":true}},"projects":{"type":["null","array"],"items":{"type":"object","properties":{"id":{"type":"string"},"name":{"type":"string"}},"required":["id","name"],"additionalProperties":true}},"team_id":{"type":"string"},"project_id":{"type":"string"},"expires_at":{"type":"string"},"error":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ProviderLoginStatus","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderLoginStatus","required":["flow_id","state","teams","projects","expires_at"],"additionalProperties":true};
...
const err10 = {instancePath:instancePath+"/teams",schemaPath:"#/properties/teams/type",keyword:"type",params:{type: schema81.properties.teams.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err10];
}
else {
...
const err16 = {instancePath:instancePath+"/projects",schemaPath:"#/properties/projects/type",keyword:"type",params:{type: schema81.properties.projects.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err16];
}
else {
...
const schema82 = {"type":"object","properties":{"flow_id":{"type":"string"},"team_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ProviderLoginTeamParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderLoginTeamParams","required":["flow_id","team_id"],"additionalProperties":true};
...
const schema83 = {"type":"object","properties":{"provider":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ProviderNameParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderNameParams","required":["provider"],"additionalProperties":true};
...
const schema84 = {"type":"object","properties":{"provider":{"type":"string"},"configured":{"type":"boolean"},"key_source":{"type":"string"},"email":{"type":"string"},"project_id":{"type":"string"},"project_name":{"type":"string"},"machine_key_name":{"type":"string"},"warnings":{"type":["null","array"],"items":{"type":"string"}}},"$id":"https://whip.dev/protocol/v3/ProviderStatus","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderStatus","required":["provider","configured","key_source","warnings"],"additionalProperties":true};
...
if((data7 !== null) && (!(Array.isArray(data7)))){
const err11 = {instancePath:instancePath+"/warnings",schemaPath:"#/properties/warnings/type",keyword:"type",params:{type: schema84.properties.warnings.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err11];
}
else {
...
const schema85 = {"type":"object","properties":{"name":{"type":"string"},"base_url":{"type":"string"},"key":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ProviderValidateParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderValidateParams","required":["name","base_url","key"],"additionalProperties":true};
...
const schema86 = {"type":"object","properties":{"models":{"type":["null","array"],"items":{"type":"object","properties":{"id":{"type":"string"},"context_length":{"type":"integer"},"max_completion_tokens":{"type":"integer"},"reasoning_efforts":{"type":["null","array"],"items":{"type":"string"}},"pricing":{"type":["null","object"],"properties":{"prompt":{"type":"string"},"completion":{"type":"string"},"input_cache_read":{"type":"string"}},"required":["prompt","completion"],"additionalProperties":true},"input_modalities":{"type":["null","array"],"items":{"type":"string"}}},"required":["id"],"additionalProperties":true}}},"$id":"https://whip.dev/protocol/v3/ProviderValidateResult","$schema":"http://json-schema.org/draft-07/schema#","title":"ProviderValidateResult","required":["models"],"additionalProperties":true};
...
let data0 = data.models;
if((data0 !== null) && (!(Array.isArray(data0)))){
const err1 = {instancePath:instancePath+"/models",schemaPath:"#/properties/models/type",keyword:"type",params:{type: schema86.properties.models.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err1];
}
else {
...
if((data5 !== null) && (!(Array.isArray(data5)))){
const err6 = {instancePath:instancePath+"/models/" + i0+"/reasoning_efforts",schemaPath:"#/properties/models/items/properties/reasoning_efforts/type",keyword:"type",params:{type: schema86.properties.models.items.properties.reasoning_efforts.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err6];
}
else {
...
if((data7 !== null) && (!(data7 && typeof data7 == "object" && !Array.isArray(data7)))){
const err8 = {instancePath:instancePath+"/models/" + i0+"/pricing",schemaPath:"#/properties/models/items/properties/pricing/type",keyword:"type",params:{type: schema86.properties.models.items.properties.pricing.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
if((data11 !== null) && (!(Array.isArray(data11)))){
const err14 = {instancePath:instancePath+"/models/" + i0+"/input_modalities",schemaPath:"#/properties/models/items/properties/input_modalities/type",keyword:"type",params:{type: schema86.properties.models.items.properties.input_modalities.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err14];
}
else {
...
const schema87 = {"type":"object","properties":{"root_id":{"type":"string"},"operation":{"type":"string"},"payload":true},"$id":"https://whip.dev/protocol/v3/QueryParams","$schema":"http://json-schema.org/draft-07/schema#","title":"QueryParams","required":["operation"],"additionalProperties":true};
...
const schema88 = {"type":"object","properties":{"result":true,"content":{"type":["null","object"],"properties":{"reference_id":{"type":"string"},"digest":{"type":"string"},"size":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"media_type":{"type":"string"},"source":{"type":"string"}},"required":["reference_id","digest","size"],"additionalProperties":true},"root_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/QueryResult","$schema":"http://json-schema.org/draft-07/schema#","title":"QueryResult","additionalProperties":true};
...
let data0 = data.content;
if((data0 !== null) && (!(data0 && typeof data0 == "object" && !Array.isArray(data0)))){
const err0 = {instancePath:instancePath+"/content",schemaPath:"#/properties/content/type",keyword:"type",params:{type: schema88.properties.content.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err0];
}
else {
...
const schema89 = {"type":"object","properties":{"id":{"type":"string"},"answer":{"type":["null","array"],"items":{"type":"string"}},"dismissed":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/QuestionAnswerParams","$schema":"http://json-schema.org/draft-07/schema#","title":"QuestionAnswerParams","required":["id","answer","dismissed"],"additionalProperties":true};
...
if((data1 !== null) && (!(Array.isArray(data1)))){
const err4 = {instancePath:instancePath+"/answer",schemaPath:"#/properties/answer/type",keyword:"type",params:{type: schema89.properties.answer.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err4];
}
else {
...
const schema90 = {"type":"object","properties":{"data":{"type":["null","object"],"properties":{"kind":{"type":"string"}},"required":["kind"],"additionalProperties":true},"code":{"type":"integer"},"message":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/RPCError","$schema":"http://json-schema.org/draft-07/schema#","title":"RPCError","required":["code","message"],"additionalProperties":true};
...
let data0 = data.data;
if((data0 !== null) && (!(data0 && typeof data0 == "object" && !Array.isArray(data0)))){
const err2 = {instancePath:instancePath+"/data",schemaPath:"#/properties/data/type",keyword:"type",params:{type: schema90.properties.data.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err2];
}
else {
...
const schema91 = {"type":"object","properties":{"root_id":{"type":"string"},"cursor":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"limit":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/ReplayParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ReplayParams","required":["root_id","cursor"],"additionalProperties":true};
...
if((data0 !== null) && (!(Array.isArray(data0)))){
const err2 = {instancePath:instancePath+"/events",schemaPath:"#/properties/events/type",keyword:"type",params:{type: schema92.properties.events.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err2];
}
else {
...
const schema93 = {"type":"object","properties":{"generation":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"cursors":{"type":"object","additionalProperties":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"}}},"$id":"https://whip.dev/protocol/v3/RestartNotice","$schema":"http://json-schema.org/draft-07/schema#","title":"RestartNotice","required":["generation","cursors"],"additionalProperties":true};
...
const schema94 = {"type":"object","properties":{"generation":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"}},"$id":"https://whip.dev/protocol/v3/RestartParams","$schema":"http://json-schema.org/draft-07/schema#","title":"RestartParams","required":["generation"],"additionalProperties":true};
...
const schema95 = {"type":"object","properties":{"expected_revision":{"type":["string","null"],"pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"cut":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/RewindParams","$schema":"http://json-schema.org/draft-07/schema#","title":"RewindParams","required":["expected_revision","cut"],"additionalProperties":true};
...
let data0 = data.expected_revision;
if((typeof data0 !== "string") && (data0 !== null)){
const err2 = {instancePath:instancePath+"/expected_revision",schemaPath:"#/properties/expected_revision/type",keyword:"type",params:{type: schema95.properties.expected_revision.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err2];
}
else {
...
const schema96 = {"type":"object","properties":{"cut":{"type":"integer"},"restored_files":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/RewindResult","$schema":"http://json-schema.org/draft-07/schema#","title":"RewindResult","required":["cut","restored_files"],"additionalProperties":true};
...
if((data4 !== null) && (!(Array.isArray(data4)))){
const err14 = {instancePath:instancePath+"/items",schemaPath:"#/properties/items/type",keyword:"type",params:{type: schema97.properties.items.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err14];
}
else {
...
const err24 = {instancePath:instancePath+"/items/" + i0+"/agent",schemaPath:"#/properties/items/items/properties/agent/type",keyword:"type",params:{type: schema97.properties.items.items.properties.agent.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err24];
}
else {
...
const err54 = {instancePath:instancePath+"/items/" + i0+"/agent/allowed_controls",schemaPath:"#/properties/items/items/properties/agent/properties/allowed_controls/type",keyword:"type",params:{type: schema97.properties.items.items.properties.agent.properties.allowed_controls.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err54];
}
else {
...
const err56 = {instancePath:instancePath+"/items/" + i0+"/inbox",schemaPath:"#/properties/items/items/properties/inbox/type",keyword:"type",params:{type: schema97.properties.items.items.properties.inbox.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err56];
}
else {
...
const err75 = {instancePath:instancePath+"/items/" + i0+"/inbox/payload/text",schemaPath:"#/properties/items/items/properties/inbox/properties/payload/properties/text/type",keyword:"type",params:{type: schema97.properties.items.items.properties.inbox.properties.payload.properties.text.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err75];
}
else {
...
const err85 = {instancePath:instancePath+"/items/" + i0+"/blackboard",schemaPath:"#/properties/items/items/properties/blackboard/type",keyword:"type",params:{type: schema97.properties.items.items.properties.blackboard.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err85];
}
else {
...
const err110 = {instancePath:instancePath+"/items/" + i0+"/budget",schemaPath:"#/properties/items/items/properties/budget/type",keyword:"type",params:{type: schema97.properties.items.items.properties.budget.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err110];
}
else {
...
const err133 = {instancePath:instancePath+"/items/" + i0+"/capability",schemaPath:"#/properties/items/items/properties/capability/type",keyword:"type",params:{type: schema97.properties.items.items.properties.capability.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err133];
}
else {
...
const err151 = {instancePath:instancePath+"/items/" + i0+"/capability/operations",schemaPath:"#/properties/items/items/properties/capability/properties/operations/type",keyword:"type",params:{type: schema97.properties.items.items.properties.capability.properties.operations.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err151];
}
else {
...
if((data64 !== null) && (!(Array.isArray(data64)))){
const err153 = {instancePath:instancePath+"/items/" + i0+"/capability/scopes",schemaPath:"#/properties/items/items/properties/capability/properties/scopes/type",keyword:"type",params:{type: schema97.properties.items.items.properties.capability.properties.scopes.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err153];
}
else {
...
const err155 = {instancePath:instancePath+"/items/" + i0+"/capability/mcp",schemaPath:"#/properties/items/items/properties/capability/properties/mcp/type",keyword:"type",params:{type: schema97.properties.items.items.properties.capability.properties.mcp.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err155];
}
else {
...
const err171 = {instancePath:instancePath+"/items/" + i0+"/schedule",schemaPath:"#/properties/items/items/properties/schedule/type",keyword:"type",params:{type: schema97.properties.items.items.properties.schedule.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err171];
}
else {
...
const err182 = {instancePath:instancePath+"/items/" + i0+"/permission",schemaPath:"#/properties/items/items/properties/permission/type",keyword:"type",params:{type: schema97.properties.items.items.properties.permission.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err182];
}
else {
...
const err207 = {instancePath:instancePath+"/items/" + i0+"/body",schemaPath:"#/properties/items/items/properties/body/type",keyword:"type",params:{type: schema97.properties.items.items.properties.body.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err207];
}
else {
...
const err213 = {instancePath:instancePath+"/items/" + i0+"/body/text",schemaPath:"#/properties/items/items/properties/body/properties/text/type",keyword:"type",params:{type: schema97.properties.items.items.properties.body.properties.text.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err213];
}
else {
...
const err214 = {instancePath:instancePath+"/items/" + i0+"/body/binary",schemaPath:"#/properties/items/items/properties/body/properties/binary/type",keyword:"type",params:{type: schema97.properties.items.items.properties.body.properties.binary.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err214];
}
else {
...
const err223 = {instancePath:instancePath+"/next_cursor",schemaPath:"#/properties/next_cursor/type",keyword:"type",params:{type: schema97.properties.next_cursor.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err223];
}
else {
...
const schema98 = {"type":"object","properties":{"root_id":{"type":"string"},"collection":{"type":"string"},"cursor":{"type":["null","object"],"properties":{"root_id":{"type":"string"},"collection":{"type":"string"},"revision":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"offset":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"}},"required":["root_id","collection","revision","offset"],"additionalProperties":true},"limit":{"type":"integer"},"max_bytes":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/RootCollectionParams","$schema":"http://json-schema.org/draft-07/schema#","title":"RootCollectionParams","required":["root_id","collection","limit","max_bytes"],"additionalProperties":true};
...
const err6 = {instancePath:instancePath+"/cursor",schemaPath:"#/properties/cursor/type",keyword:"type",params:{type: schema98.properties.cursor.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err6];
}
else {
...
const schema99 = {"type":"object","properties":{"root_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/RootIDResult","$schema":"http://json-schema.org/draft-07/schema#","title":"RootIDResult","required":["root_id"],"additionalProperties":true};
...
const schema100 = {"type":"object","properties":{"root_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/RootParams","$schema":"http://json-schema.org/draft-07/schema#","title":"RootParams","required":["root_id"],"additionalProperties":true};
...
if((data4 !== null) && (!(Array.isArray(data4)))){
const err21 = {instancePath:instancePath+"/message_seqs",schemaPath:"#/properties/message_seqs/type",keyword:"type",params:{type: schema101.properties.message_seqs.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err21];
}
else {
...
if((data20 !== null) && (!(Array.isArray(data20)))){
const err56 = {instancePath:instancePath+"/meta/tags",schemaPath:"#/properties/meta/properties/tags/type",keyword:"type",params:{type: schema101.properties.meta.properties.tags.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err56];
}
else {
...
const err65 = {instancePath:instancePath+"/messages",schemaPath:"#/properties/messages/type",keyword:"type",params:{type: schema101.properties.messages.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err65];
}
else {
...
let data32 = data29.tool_calls;
if((data32 !== null) && (!(Array.isArray(data32)))){
const err70 = {instancePath:instancePath+"/messages/" + i2+"/tool_calls",schemaPath:"#/properties/messages/items/properties/tool_calls/type",keyword:"type",params:{type: schema101.properties.messages.items.properties.tool_calls.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err70];
}
else {
...
let data44 = data29.sent_at;
if((data44 !== null) && (typeof data44 !== "string")){
const err87 = {instancePath:instancePath+"/messages/" + i2+"/sent_at",schemaPath:"#/properties/messages/items/properties/sent_at/type",keyword:"type",params:{type: schema101.properties.messages.items.properties.sent_at.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err87];
}
else {
...
let data45 = data29.usage;
if((data45 !== null) && (!(data45 && typeof data45 == "object" && !Array.isArray(data45)))){
const err88 = {instancePath:instancePath+"/messages/" + i2+"/usage",schemaPath:"#/properties/messages/items/properties/usage/type",keyword:"type",params:{type: schema101.properties.messages.items.properties.usage.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err88];
}
else {
...
if((data52 !== null) && (!(Array.isArray(data52)))){
const err99 = {instancePath:instancePath+"/presentation",schemaPath:"#/properties/presentation/type",keyword:"type",params:{type: schema101.properties.presentation.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err99];
}
else {
...
const err108 = {instancePath:instancePath+"/agent_presentations/" + key2.replace(/~/g, "~0").replace(/\//g, "~1"),schemaPath:"#/properties/agent_presentations/additionalProperties/type",keyword:"type",params:{type: schema101.properties.agent_presentations.additionalProperties.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err108];
}
else {
...
const err118 = {instancePath:instancePath+"/agents",schemaPath:"#/properties/agents/type",keyword:"type",params:{type: schema101.properties.agents.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err118];
}
else {
...
const err148 = {instancePath:instancePath+"/agents/" + i6+"/allowed_controls",schemaPath:"#/properties/agents/items/properties/allowed_controls/type",keyword:"type",params:{type: schema101.properties.agents.items.properties.allowed_controls.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err148];
}
else {
...
const err151 = {instancePath:instancePath+"/inbox",schemaPath:"#/properties/inbox/type",keyword:"type",params:{type: schema101.properties.inbox.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err151];
}
else {
...
const err170 = {instancePath:instancePath+"/inbox/" + i8+"/payload/text",schemaPath:"#/properties/inbox/items/properties/payload/properties/text/type",keyword:"type",params:{type: schema101.properties.inbox.items.properties.payload.properties.text.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err170];
}
else {
...
const err171 = {instancePath:instancePath+"/inbox/" + i8+"/payload/binary",schemaPath:"#/properties/inbox/items/properties/payload/properties/binary/type",keyword:"type",params:{type: schema101.properties.inbox.items.properties.payload.properties.binary.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err171];
}
else {
...
const err181 = {instancePath:instancePath+"/blackboard",schemaPath:"#/properties/blackboard/type",keyword:"type",params:{type: schema101.properties.blackboard.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err181];
}
else {
...
const err196 = {instancePath:instancePath+"/blackboard/" + i9+"/payload/text",schemaPath:"#/properties/blackboard/items/properties/payload/properties/text/type",keyword:"type",params:{type: schema101.properties.blackboard.items.properties.payload.properties.text.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err196];
}
else {
...
const err197 = {instancePath:instancePath+"/blackboard/" + i9+"/payload/binary",schemaPath:"#/properties/blackboard/items/properties/payload/properties/binary/type",keyword:"type",params:{type: schema101.properties.blackboard.items.properties.payload.properties.binary.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err197];
}
else {
...
const err207 = {instancePath:instancePath+"/budgets",schemaPath:"#/properties/budgets/type",keyword:"type",params:{type: schema101.properties.budgets.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err207];
}
else {
...
const err231 = {instancePath:instancePath+"/capabilities",schemaPath:"#/properties/capabilities/type",keyword:"type",params:{type: schema101.properties.capabilities.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err231];
}
else {
...
const err249 = {instancePath:instancePath+"/capabilities/" + i11+"/operations",schemaPath:"#/properties/capabilities/items/properties/operations/type",keyword:"type",params:{type: schema101.properties.capabilities.items.properties.operations.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err249];
}
else {
...
const err251 = {instancePath:instancePath+"/capabilities/" + i11+"/scopes",schemaPath:"#/properties/capabilities/items/properties/scopes/type",keyword:"type",params:{type: schema101.properties.capabilities.items.properties.scopes.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err251];
}
else {
...
const err253 = {instancePath:instancePath+"/capabilities/" + i11+"/mcp",schemaPath:"#/properties/capabilities/items/properties/mcp/type",keyword:"type",params:{type: schema101.properties.capabilities.items.properties.mcp.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err253];
}
else {
...
const err270 = {instancePath:instancePath+"/schedules",schemaPath:"#/properties/schedules/type",keyword:"type",params:{type: schema101.properties.schedules.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err270];
}
else {
...
const err282 = {instancePath:instancePath+"/permissions",schemaPath:"#/properties/permissions/type",keyword:"type",params:{type: schema101.properties.permissions.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err282];
}
else {
...
const err308 = {instancePath:instancePath+"/questions",schemaPath:"#/properties/questions/type",keyword:"type",params:{type: schema101.properties.questions.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err308];
}
else {
...
const err341 = {instancePath:instancePath+"/questions/" + i17+"/restored",schemaPath:"#/properties/questions/items/properties/restored/type",keyword:"type",params:{type: schema101.properties.questions.items.properties.restored.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err341];
}
else {
...
const err343 = {instancePath:instancePath+"/questions/" + i17+"/not_restored",schemaPath:"#/properties/questions/items/properties/not_restored/type",keyword:"type",params:{type: schema101.properties.questions.items.properties.not_restored.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err343];
}
else {
...
const err376 = {instancePath:instancePath+"/questions/" + i17+"/options",schemaPath:"#/properties/questions/items/properties/options/type",keyword:"type",params:{type: schema101.properties.questions.items.properties.options.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err376];
}
else {
...
const err382 = {instancePath:instancePath+"/questions/" + i17+"/answer",schemaPath:"#/properties/questions/items/properties/answer/type",keyword:"type",params:{type: schema101.properties.questions.items.properties.answer.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err382];
}
else {
...
const schema102 = {"type":"object","properties":{"system":{"type":"string"},"max_turns":{"type":"integer"},"headless":{"type":"boolean"},"cache_key":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/RunConfigureParams","$schema":"http://json-schema.org/draft-07/schema#","title":"RunConfigureParams","additionalProperties":true};
...
const schema104 = {"type":"object","properties":{"schedule":{"type":"string"},"prompt":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ScheduleCreateParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ScheduleCreateParams","required":["schedule","prompt"],"additionalProperties":true};
...
const schema105 = {"type":"object","properties":{"schedule_id":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/ScheduleDeleteParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ScheduleDeleteParams","required":["schedule_id"],"additionalProperties":true};
...
const schema107 = {"type":"object","properties":{"schedule_id":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/ScheduleResult","$schema":"http://json-schema.org/draft-07/schema#","title":"ScheduleResult","required":["schedule_id"],"additionalProperties":true};
...
const schema108 = {"type":"object","properties":{"revision":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"items":{"type":["null","array"],"items":{"type":"object","properties":{"id":{"type":"string"},"kind":{"type":"string"},"title":{"type":"string"},"model":{"type":"string"},"provider":{"type":"string"},"cwd":{"type":"string"},"pinned":{"type":"boolean"},"updated_at":{"type":"string"},"truncated":{"type":"boolean"}},"required":["id","kind","title","model","provider","cwd","pinned","updated_at","truncated"],"additionalProperties":true}},"next_cursor":{"type":["null","object"],"properties":{"revision":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"offset":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"}},"required":["revision","offset"],"additionalProperties":true},"has_more":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/SessionCatalogPage","$schema":"http://json-schema.org/draft-07/schema#","title":"SessionCatalogPage","required":["revision","items","has_more"],"additionalProperties":true};
...
if((data1 !== null) && (!(Array.isArray(data1)))){
const err6 = {instancePath:instancePath+"/items",schemaPath:"#/properties/items/type",keyword:"type",params:{type: schema108.properties.items.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err6];
}
else {
...
const err26 = {instancePath:instancePath+"/next_cursor",schemaPath:"#/properties/next_cursor/type",keyword:"type",params:{type: schema108.properties.next_cursor.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err26];
}
else {
...
const schema109 = {"type":"object","properties":{"cursor":{"type":["null","object"],"properties":{"revision":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"offset":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"}},"required":["revision","offset"],"additionalProperties":true},"limit":{"type":"integer"},"max_bytes":{"type":"integer"}},"$id":"https://whip.dev/protocol/v3/SessionCatalogParams","$schema":"http://json-schema.org/draft-07/schema#","title":"SessionCatalogParams","required":["limit","max_bytes"],"additionalProperties":true};
...
let data0 = data.cursor;
if((data0 !== null) && (!(data0 && typeof data0 == "object" && !Array.isArray(data0)))){
const err2 = {instancePath:instancePath+"/cursor",schemaPath:"#/properties/cursor/type",keyword:"type",params:{type: schema109.properties.cursor.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err2];
}
else {
...
const schema110 = {"type":["null","array"],"items":{"type":"object","properties":{"id":{"type":"string"},"kind":{"type":"string"},"title":{"type":"string"},"model":{"type":"string"},"provider":{"type":"string"},"cwd":{"type":"string"},"goal":{"type":"string"},"forked_from":{"type":"string"},"fork_seq":{"type":"integer"},"tags":{"type":["null","array"],"items":{"type":"string"}},"pinned":{"type":"boolean"},"effort":{"type":"string"},"usage_in":{"type":"integer"},"usage_cached":{"type":"integer"},"usage_out":{"type":"integer"},"updated_at":{"type":"string"}},"required":["id","kind","title","model","provider","cwd","goal","forked_from","fork_seq","tags","pinned","effort","usage_in","usage_cached","usage_out","updated_at"],"additionalProperties":true},"$id":"https://whip.dev/protocol/v3/SessionListResult","$schema":"http://json-schema.org/draft-07/schema#","title":"SessionListResult"};
...
const err26 = {instancePath:instancePath+"/" + i0+"/tags",schemaPath:"#/items/properties/tags/type",keyword:"type",params:{type: schema110.items.properties.tags.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err26];
}
else {
...
const schema111 = {"type":"object","properties":{"root_id":{"type":"string"},"user":{"type":"string"},"assistant":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/SessionPreviewResult","$schema":"http://json-schema.org/draft-07/schema#","title":"SessionPreviewResult","required":["root_id","user","assistant"],"additionalProperties":true};
...
const schema112 = {"type":"object","properties":{"title":{"type":"string"},"model":{"type":"string"},"provider":{"type":"string"},"effort":{"type":"string"},"effort_changed":{"type":"boolean"},"working_directory":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/SessionUpdateEvent","$schema":"http://json-schema.org/draft-07/schema#","title":"SessionUpdateEvent","additionalProperties":true};
...
const schema113 = {"type":"object","properties":{"command":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/ShellParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ShellParams","required":["command"],"additionalProperties":true};
...
const schema114 = {"type":"object","properties":{"root_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/SnapshotParams","$schema":"http://json-schema.org/draft-07/schema#","title":"SnapshotParams","required":["root_id"],"additionalProperties":true};
...
const schema115 = {"type":"object","properties":{"usage":{"type":["null","object"],"properties":{"used":{"type":"integer"},"size":{"type":"integer"},"usage":{"type":"object","properties":{"prompt_tokens":{"type":"integer"},"completion_tokens":{"type":"integer"},"prompt_tokens_details":{"type":["null","object"],"properties":{"cached_tokens":{"type":"integer"}},"required":["cached_tokens"],"additionalProperties":true}},"required":["prompt_tokens","completion_tokens"],"additionalProperties":true}},"required":["used","size","usage"],"additionalProperties":true},"agent_id":{"type":"string"},"id":{"type":"string"},"name":{"type":"string"},"text":{"type":"string"},"args":{"type":"string"},"result":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/StreamEvent","$schema":"http://json-schema.org/draft-07/schema#","title":"StreamEvent","additionalProperties":true};
...
if((data0 !== null) && (!(data0 && typeof data0 == "object" && !Array.isArray(data0)))){
const err0 = {instancePath:instancePath+"/usage",schemaPath:"#/properties/usage/type",keyword:"type",params:{type: schema115.properties.usage.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err0];
}
else {
...
if((data6 !== null) && (!(data6 && typeof data6 == "object" && !Array.isArray(data6)))){
const err10 = {instancePath:instancePath+"/usage/usage/prompt_tokens_details",schemaPath:"#/properties/usage/properties/usage/properties/prompt_tokens_details/type",keyword:"type",params:{type: schema115.properties.usage.properties.usage.properties.prompt_tokens_details.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err10];
}
else {
...
if((data1 !== null) && (!(Array.isArray(data1)))){
const err2 = {instancePath:instancePath+"/parts",schemaPath:"#/properties/parts/type",keyword:"type",params:{type: schema116.properties.parts.type},message:"must be null,array"};
if(vErrors === null){
vErrors = [err2];
}
else {
...
if((data5 !== null) && (!(data5 && typeof data5 == "object" && !Array.isArray(data5)))){
const err6 = {instancePath:instancePath+"/parts/" + i0+"/image_url",schemaPath:"#/properties/parts/items/properties/image_url/type",keyword:"type",params:{type: schema116.properties.parts.items.properties.image_url.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err6];
}
else {
...
const schema118 = {"type":"object","properties":{"subscription_id":{"type":"string"},"cursor":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"}},"$id":"https://whip.dev/protocol/v3/SubscribeResult","$schema":"http://json-schema.org/draft-07/schema#","title":"SubscribeResult","required":["subscription_id","cursor"],"additionalProperties":true};
...
const schema119 = {"type":"object","properties":{"subscription_id":{"type":"string"},"root_id":{"type":"string"},"error":{"type":["null","object"],"properties":{"data":{"type":["null","object"],"properties":{"kind":{"type":"string"}},"required":["kind"],"additionalProperties":true},"code":{"type":"integer"},"message":{"type":"string"}},"required":["code","message"],"additionalProperties":true}},"$id":"https://whip.dev/protocol/v3/SubscriptionFailure","$schema":"http://json-schema.org/draft-07/schema#","title":"SubscriptionFailure","required":["subscription_id","root_id","error"],"additionalProperties":true};
...
if((data2 !== null) && (!(data2 && typeof data2 == "object" && !Array.isArray(data2)))){
const err5 = {instancePath:instancePath+"/error",schemaPath:"#/properties/error/type",keyword:"type",params:{type: schema119.properties.error.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err5];
}
else {
...
const err8 = {instancePath:instancePath+"/error/data",schemaPath:"#/properties/error/properties/data/type",keyword:"type",params:{type: schema119.properties.error.properties.data.type},message:"must be null,object"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
const schema120 = {"type":"object","properties":{"id":{"type":"string"},"bytes":{"type":["string","null"],"pattern":"^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$","contentEncoding":"base64"}},"$id":"https://whip.dev/protocol/v3/TerminalInputParams","$schema":"http://json-schema.org/draft-07/schema#","title":"TerminalInputParams","required":["id","bytes"],"additionalProperties":true};
...
const err3 = {instancePath:instancePath+"/bytes",schemaPath:"#/properties/bytes/type",keyword:"type",params:{type: schema120.properties.bytes.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err3];
}
else {
...
const schema121 = {"type":"object","properties":{"text":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/TextParams","$schema":"http://json-schema.org/draft-07/schema#","title":"TextParams","required":["text"],"additionalProperties":true};
...
const schema122 = {"type":"object","properties":{"text":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/TextResult","$schema":"http://json-schema.org/draft-07/schema#","title":"TextResult","required":["text"],"additionalProperties":true};
...
const schema123 = {"type":"object","properties":{"title":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/TitleParams","$schema":"http://json-schema.org/draft-07/schema#","title":"TitleParams","required":["title"],"additionalProperties":true};
...
const schema124 = {"type":"object","properties":{"title":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/TitleResult","$schema":"http://json-schema.org/draft-07/schema#","title":"TitleResult","required":["title"],"additionalProperties":true};
...
const schema125 = {"type":"object","properties":{"tool":{"type":"string"},"arguments":true},"$id":"https://whip.dev/protocol/v3/ToolCallParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ToolCallParams","required":["tool","arguments"],"additionalProperties":true};
...
const schema126 = {"type":"object","properties":{"deny_permissions":{"type":"boolean"}},"$id":"https://whip.dev/protocol/v3/ToolConfigureParams","$schema":"http://json-schema.org/draft-07/schema#","title":"ToolConfigureParams","required":["deny_permissions"],"additionalProperties":true};
...
const schema127 = {"type":["null","array"],"items":{"type":"object","properties":{"type":{"type":"string"},"function":{"type":"object","properties":{"name":{"type":"string"},"description":{"type":"string"},"parameters":true},"required":["name","description","parameters"],"additionalProperties":true}},"required":["type","function"],"additionalProperties":true},"$id":"https://whip.dev/protocol/v3/ToolSchemaResult","$schema":"http://json-schema.org/draft-07/schema#","title":"ToolSchemaResult"};
...
const schema128 = {"type":"object","properties":{"subscription_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/UnsubscribeParams","$schema":"http://json-schema.org/draft-07/schema#","title":"UnsubscribeParams","required":["subscription_id"],"additionalProperties":true};
...
const schema130 = {"type":"object","properties":{"upload_id":{"type":"string"},"offset":{"type":"string","pattern":"^-?(0|[1-9][0-9]*)$","format":"int64"},"data":{"type":["string","null"],"pattern":"^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$","contentEncoding":"base64"}},"$id":"https://whip.dev/protocol/v3/UploadChunkParams","$schema":"http://json-schema.org/draft-07/schema#","title":"UploadChunkParams","required":["upload_id","offset","data"],"additionalProperties":true};
...
const err7 = {instancePath:instancePath+"/data",schemaPath:"#/properties/data/type",keyword:"type",params:{type: schema130.properties.data.type},message:"must be string,null"};
if(vErrors === null){
vErrors = [err7];
}
else {
...
const schema131 = {"type":"object","properties":{"upload_id":{"type":"string"}},"$id":"https://whip.dev/protocol/v3/UploadFinishParams","$schema":"http://json-schema.org/draft-07/schema#","title":"UploadFinishParams","required":["upload_id"],"additionalProperties":true};
