...
existing SDK client; direct URL connections use its ordinary network transport.
...
addresses. Switching hosts cancels and disposes only the previous connection.
...
question/permission attention metadata for the selected host while the app is
