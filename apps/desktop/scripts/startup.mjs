...
async function selfTest() {
  ...
  try {
    ...
    const dom = new JSDOM('<aside aria-label="Session navigation"><button aria-label="Change execution host: This Mac">This Mac</button></aside><form><textarea data-whip-composer aria-label="Message WHIP"></textarea><button aria-label="Add context" disabled></button></form><section aria-label="Conversation"><div data-message-id="fixture">Verified Whip desktop startup fixture: 42</div></section>',
