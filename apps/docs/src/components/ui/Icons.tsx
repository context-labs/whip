...
type IconName = 'copy' | 'check' | 'chevron' | 'close' | 'menu' | 'arrow-left' | 'arrow-right' | 'theme' | 'download';
const paths: Record<IconName, string> = {
  copy: 'M9 9h11v11H9z M5 15H4V4h11v1',
  check: 'm5 12 4 4L19 6', chevron: 'm6 9 6 6 6-6',
...
export function Icon({ name, ...props }: SVGProps<SVGSVGElement> & { name: IconName }) {
  return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><path d={paths[name]} /></svg>;
}
// Discord's mark from Paper header Y8-0, inheriting the neutral theme colour.
...
// GitHub's official 16px mark, rendered in the surrounding neutral text colour.
