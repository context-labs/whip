...
export function SiteHeader() {
  return <header className="site-header">
    <div className="site-header-inner">
      <a href={sitePath('/')} className="brand-link" aria-label="whipcode home"><Wordmark /></a>
      <div className="header-actions">
        ...
        <a className="button header-download" href={sitePath('/docs/download')} aria-label="Download">
